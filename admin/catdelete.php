...
<?php
		...
		$res=$obj->getdata("select * from cat_tbl where cat_id='$id1'");
	...
	<form action="y.php" method="post">
	    <div class="panel panel-danger">
                <div class="panel-heading">Delete Record</div>
                    ...
                    <label class="form-control">Catagory Id:</label>
                    <input type="text " name="txtcatid" class="form-control" value="<?php echo $catid ?>" read only>
                      <br>
                      <label  class="form-control">Catagory Name:</label>
                     <label  class="form-control"><?php echo $catname ?></label>
                     <br>
                    <span class="fnt">Are you sure you wanna delete this record?</span><br>
                        <input class="btn" class="form-control" type="submit" name="btnsubmit" value="Delete" style="height: 30px;width: 90px;"/>
